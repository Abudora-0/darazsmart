...
function SignInForm() {
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-10">
      <div className="animate-fade-up w-full max-w-sm rounded-3xl bg-white p-8 ring-1 ring-black/5 shadow-[0_20px_50px_-20px_rgba(50,25,110,0.35)]">
        <h1 className="mb-1 text-xl font-bold text-[#1a1730]">
